...
public class ApiResult<T> {
    ...
    private T data;
    private List<uz.ataboyev.debtbook.payload.ErrorData> errors;
    ...
    public ApiResult(String errorMsg, Integer errorCode) {
        this.success = false;
        this.errors = Collections.singletonList(new uz.ataboyev.debtbook.payload.ErrorData(errorMsg, errorCode));
    }

    //ERROR RESPONSE WITH ERROR DATA LIST
    public ApiResult(List<uz.ataboyev.debtbook.payload.ErrorData> errors) {
        this.success = false;
        this.errors = errors;
    }
